...
\date{Public review update of August 13, 2026}
...
Current hardware basis & Kria-based \GIZMO{} rack described by DUNE-doc-35392-v2; it is the currently implemented reference for the public interface. \\
Legacy basis & ZedBoard/Zynq \GIZMO{} documents DUNE-doc-1805-v12, 25365-v1, and 27482-v2. \\
Machine contract & The companion GIZMo--SC ICD defines the hardware-neutral, canonical \texttt{urn:fnal:gizmo} OPC~UA model; any \GIZMO{} hardware implementation shall conform to it. Current released model baseline: 1.3.1. \\
...
The GIZMo--SC ICD defines one hardware-neutral OPC~UA contract. Its namespace
URI is \nolinkurl{urn:fnal:gizmo}. Any \GIZMO{} hardware implementation shall
conform to the contract.  The Kria server is the currently implemented reference. Site
...
The planned ZedBoard OPC~UA server shall conform to the hardware-neutral
...
display-comparison, restart, network-loss, and non-interference tests pass; all
ZedBoard OPC~UA writes and methods remain disabled until separately accepted.
